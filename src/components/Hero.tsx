...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 z-0 rounded-none pt-10`}>
      ...
      <div className={`relative z-20 section-container text-center text-white`}>
        <div className={`max-w-4xl mx-auto space-y-6 slide-up`}>
          ...
          <p
            className={`text-white/95 max-w-2xl mx-auto leading-relaxed text-[1.38728em]`}
          >
          ...
          <div className={`pt-4`}>
            <Button
              ...
              className={`bg-linear-to-r from-orange-500 to-orange-400 text-secondary-foreground px-8 py-6 rounded-full shadow-secondary hover:shadow-hover-secondary transition-all hover:scale-105`}
            >
              Fale Conosco
            </Button>
          </div>
